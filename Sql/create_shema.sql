...
insert into stations_air.description (idobj, network, fullname,id, station_type, altitude,x,y,geom, pluginlink) values (uuid_generate_v4(),'Nabel','Payerne',998,'quality',489,562285,184775, GeometryFromText( 'POINT(562285 184775)', 21781 ), '<a href="javascript:sitn.meteoDataWindow(''998'',true, true)"><img src="http://nesitnd1.ne.ch/demo_air/wsgi/proj/images/normal/chart.png" onload="sitn.meteoDataWindow(''998'',true, true)"></a>' );
insert into stations_air.description (idobj, network, fullname,id, station_type, altitude,x,y,geom, pluginlink) values (uuid_generate_v4(),'Nabel','Chaumont',999,'quality',1136,565090,211040, GeometryFromText( 'POINT(565090 211040)', 21781 ), '<a href="javascript:sitn.meteoDataWindow(''999'',true, false);"><img src="http://nesitnd1.ne.ch/demo_air/wsgi/proj/images/normal/chart.png" onload="sitn.meteoDataWindow(''999'',true, false)"></a>' );
insert into stations_air.description (idobj, network, fullname,id, station_type, altitude,x,y,geom, pluginlink) values (uuid_generate_v4(),'SamWI','Le Landeron',802,'quality',431,571175,210800, GeometryFromText( 'POINT(571175 210800)', 21781 ), '<a href="javascript:sitn.meteoDataWindow(''802'',true, false);"><img src="http://nesitnd1.ne.ch/demo_air/wsgi/proj/images/normal/chart.png" onload="sitn.meteoDataWindow(''802'',true, false)"></a>' );
insert into stations_air.description (idobj, network, fullname,id, station_type, altitude,x,y,geom, pluginlink) values (uuid_generate_v4(),'SamWI','Neuchatel',804,'quality',460,561518,204935, GeometryFromText( 'POINT(561518 204935)', 21781 ), '<a href="javascript:sitn.meteoDataWindow(''804'',true, false);"><img src="http://nesitnd1.ne.ch/demo_air/wsgi/proj/images/normal/chart.png" onload="sitn.meteoDataWindow(''804'',true, false)"></a>');
insert into stations_air.description (idobj, network, fullname,id, station_type, altitude,x,y,geom, pluginlink) values (uuid_generate_v4(),'SamWI','la Chaux-de-Fonds',805,'quality',997,553467,216963, GeometryFromText( 'POINT(553467 216963)', 21781 ), '<a href="javascript:sitn.meteoDataWindow(''805'',true, false);"><img src="http://nesitnd1.ne.ch/demo_air/wsgi/proj/images/normal/chart.png" onload="sitn.meteoDataWindow(''805'',true, false)"></a>');
insert into stations_air.description (idobj, network, fullname,id, station_type, altitude,x,y,geom, pluginlink) values (uuid_generate_v4(),'SamWI','Locle',807,'quality',931,548581,212842, GeometryFromText( 'POINT(548581 212842)', 21781 ), '<a href="javascript:sitn.meteoDataWindow(''807'',true, false);"><img src="http://nesitnd1.ne.ch/demo_air/wsgi/proj/images/normal/chart.png" onload="sitn.meteoDataWindow(''807'',true, false)"></a>' );
insert into stations_air.description (idobj, network, fullname,id, station_type, altitude,x,y,geom, pluginlink) values (uuid_generate_v4(),'Combilog','Bevaix (vis-a-vis Apollo)',32,'meteo',494,553241,198441, GeometryFromText( 'POINT(553241 198441)', 21781 ), '<a href="javascript:sitn.meteoDataWindow(''032'',true, true);"><img src="http://nesitnd1.ne.ch/demo_air/wsgi/proj/images/normal/chart.png" onload="sitn.meteoDataWindow(''032'',true, true)"></a>' );
insert into stations_air.description (idobj, network, fullname,id, station_type, altitude,x,y,geom, pluginlink) values (uuid_generate_v4(),'Combilog','Jolimont (Erlach)',36,'meteo',450,571321,208498, GeometryFromText( 'POINT(571321 208498)', 21781 ), '<a href="javascript:sitn.meteoDataWindow(''036'',true, true);"><img src="http://nesitnd1.ne.ch/demo_air/wsgi/proj/images/normal/chart.png" onload="sitn.meteoDataWindow(''036'',true, true)"></a>');
insert into stations_air.description (idobj, network, fullname,id, station_type, altitude,x,y,geom, pluginlink) values (uuid_generate_v4(),'Combilog','Neuchatel (Nid-du-Cro)',40,'meteo',435,563041,205228, GeometryFromText( 'POINT(563041 205228)', 21781 ), '<a href="javascript:sitn.meteoDataWindow(''040'',true, true);"><img src="http://nesitnd1.ne.ch/demo_air/wsgi/proj/images/normal/chart.png" onload="sitn.meteoDataWindow(''040'',true, true)"></a>' );
insert into stations_air.description (idobj, network, fullname,id, station_type, altitude,x,y,geom, pluginlink) values (uuid_generate_v4(),'Combilog','Cernier (Evologia)',41,'meteo',777,559710,211909, GeometryFromText( 'POINT(559710 211909)', 21781 ), '<a href="javascript:sitn.meteoDataWindow(''041'',true, true);"><img src="http://nesitnd1.ne.ch/demo_air/wsgi/proj/images/normal/chart.png" onload="sitn.meteoDataWindow(''041'',true, true)"></a>' );
insert into stations_air.description (idobj, network, fullname,id, station_type, altitude,x,y,geom, pluginlink) values (uuid_generate_v4(),'Combilog','La Sagne (Step)',42,'meteo',1015,551005,209287, GeometryFromText( 'POINT(551005 209287)', 21781 ), '<a href="javascript:sitn.meteoDataWindow(''042'',true, true);"><img src="http://nesitnd1.ne.ch/demo_air/wsgi/proj/images/normal/chart.png" onload="sitn.meteoDataWindow(''042'',true, true)"></a>' );
