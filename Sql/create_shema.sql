...
insert into stations_air.description (idobj, network, fullname,id, station_type, altitude,x,y,geom, pluginlink) values (uuid_generate_v4(),'Combilog','Auvernier',50,'meteo',446,558425,203333, GeometryFromText( 'POINT(558425 203333)', 21781 ), '<a href="javascript:sitn.meteoDataWindow(''050'',true, true);"><img src="http://nesitnd1.ne.ch/demo_air/wsgi/proj/images/normal/chart.png" onload="sitn.meteoDataWindow(''050'',true, true)" onerror="sitn.meteoDataWindow(''050'',true, true)"></a>' );
